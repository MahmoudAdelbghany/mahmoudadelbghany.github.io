...
###  SCU Racing Team 
**Autonmous Team Member**  
_Jan. 2024 – Dec. 2024_  
- Helped co-found the autonomous team and participated in the EVER V 2024 autonomous track competition.
- Worked on ROS, CoppeliaSim, and Kalman filters, among other tasks related to simulating autonomous vehicles.
...
_Ismailia, Egypt | Jan. 2024 – Present_  
- Volunteered as a student with the Suez Canal University Community Service Center.
- Led the creation of a battery-powered car project with children, including interactive sessions on electricity, motors, and Arduino basics.
- Prepared children for a competition with other schools and orphanages.
...
- C (Proficient), C++ (Intermediate), Python (Intermediate), Lua (Familiar)

### Embedded Systems
- AVR Interfacing (Proficient), ESP32 (Proficient), Arduino (Proficient) RTOS (Intermediate), ROS1(Intermediate)

### Tools & Platforms
- Proteus (Proficient), Atmel Studio (Proficient), PlatformIO (Intermediate), Git/GitHub (Intermediate), GDB (Intermediate), Firebase (Familiar)
